...
#include "HacExportedBackground.h"
...
struct ExportedBackgroundLocalInfo {
    ...
    QSet<HacExportedBackground *> localInstance;
};
...
/*!
    \class HacExportedBackground
    \inpublicgroup QtBaseModule

    \brief The HacExportedBackground class provides access to the system
    background.
    ...
    notified that the background pixmap has changed.  HacExportedBackground
    provides this functionality.
*/

/*!
    \fn void HacExportedBackground::changed()

    This signal is emitted when the exported background changes.
*/

/*!
    \fn void HacExportedBackground::changed(const QPixmap &background)
...
/*!
    \fn void HacExportedBackground::wallpaperChanged()
    \deprecated
...
/*!
    Constructs a HacExportedBackground for screen number \a screen with
    the given \a parent.
    ...
    \sa QDesktopWidget
*/
HacExportedBackground::HacExportedBackground(int screen, QObject *parent)
    : QObject(parent)
{
    d = new HacExportedBackgroundPrivate;
    d->screen = screen;
...
/*!
    Constructs a HacExportedBackground for the default screen with the
    given \a parent.
*/
HacExportedBackground::HacExportedBackground(QObject *parent)
    : QObject(parent)
{
    int scr = 0;
    d = new HacExportedBackgroundPrivate;
...
/*!
    Destroys a HacExportedBackground.
*/
HacExportedBackground::~HacExportedBackground()
{
    if ( d )
        delete d;
    d = 0;
...
*/
const QPixmap &HacExportedBackground::background() const
{
    return d->bg;
}
...
*/
bool HacExportedBackground::isAvailable() const
{
#ifndef USE_PIXMAP_QWS_BITS
...
void HacExportedBackground::sysMessage(const QString &msg, const QByteArray&)
{
...
/*!
    \internal
*/
void HacExportedBackground::polishWindows(int screen)
{
...
void HacExportedBackground::getPixmaps()
{
    d->bg = QPixmap();
    d->state = QPixmap();
...
/*!
    \internal
*/
QSize HacExportedBackground::exportedBackgroundSize(int screen)
{
...
/*!
    \internal
*/
void HacExportedBackground::initExportedBackground(int width, int height, int screen)
{
    if (screen < 0 || screen >= MaxScreens)
        return;
...
/*!
    \internal
*/
void HacExportedBackground::clearExportedBackground(int screen)
{
    if (screen < 0 || screen >= MaxScreens)
        return;
...
#endif
    foreach(HacExportedBackground *bg, localInfo()->localInstance)
        bg->getPixmaps();
}
...
/*!
    \internal
*/
void HacExportedBackground::setExportedBackgroundTint(int tint)
{
...
/*!
    \internal
*/
void HacExportedBackground::setExportedBackground(const QPixmap &image, int screen)
{
    if (screen < 0 || screen >= MaxScreens)
        return;
